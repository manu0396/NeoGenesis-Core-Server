...
interface PrintSessionStore {
    ...
    fun updateStatus(sessionId: String, status: PrintSessionStatus, updatedAtMs: Long)
...
interface GdprStore {
    ...
    fun latestConsent(patientId: String, purpose: String): GdprConsentRecord?
...
interface RegulatoryStore {
    ...
    fun updateCapaStatus(capaId: Long, status: String, updatedAtMs: Long): Boolean
